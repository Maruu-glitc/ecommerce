                                    ...
                                    <td class="ps-4 py-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-primary fw-bold">{{ $item->product->formatted_price }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ route('cart.update', $item->id) }}" method="POST" class="d-inline-block">
                                            ...
                                            <div class="input-group quantity-grid-sm mx-auto">
                                                ...
                                                <span class="input-group-text bg-white border-start-0 small text-muted">pcs</span>
                                            </div>
                                        </form>
                                        ...
                                        <form action="{{ route('cart.remove', $item->id) }}" method="POST" class="mt-2">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-link btn-sm  text-decoration-none p-0 " style="color: red"
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm fm-card sticky-top" style="top: 2rem;">
                <div class="card-body p-4">
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            <a href="{{ route('checkout.index') }}" class="btn btn-foodmart w-100 py-3 fw-bold text-uppercase">
                                <i class="bi bi-shield-check me-2"></i>Lanjut Checkout
                            </a>
                        </div>
                        <div class="col-12">
                            <a href="{{ route('catalog.index') }}" class="btn btn-outline-secondary w-100 py-2 fw-semibold">
