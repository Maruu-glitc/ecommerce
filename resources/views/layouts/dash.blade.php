...
<html lang="en">
  ...
  <body>
    ...
    <div class="offcanvas-header">
        <h5 class="offcanvas-title">Keranja</h5>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{asset('images/iklanKaos.jpeg')}}" class="img-fluid">
                        </div>
                      </div>
                    </div>
...
<!-- end Category Section -->
    ...
    <!-- Peroduk terbaru section -->
    <section class="py-5 overflow-hidden">
      <div class="container-fluid">
            <!-- Carousel product terbaru  -->
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap flex-wrap justify-content-between mb-5">
              ...
              <!-- end Carousel product terbaru  -->

              <!-- Dafatar produk terbaru -->
        <div class="row">
          <div class="col-md-12">
