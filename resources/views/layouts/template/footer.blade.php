        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 ">
            <div class="footer-menu">
              <img src="{{ asset('images/logoDistro2.png') }}" width="210" alt="logo">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">Tentang Distro</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">Tentang Kami</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Cerita Brand</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Koleksi Terbaru</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Karir</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Reseller & Partnership</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Media & Press</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">Pusat Bantuan (FAQ)</a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Retur & Penukaran</a>
                </li>
                <li class="menu-item">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">Belanja</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">Kaos Pria</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Kaos Wanita</a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Promo & Diskon</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Ukuran & Panduan</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              ...
              <form class="d-flex mt-3 gap-0" role="newsletter">
                <input class="form-control rounded-start rounded-0 bg-light" style="border: 1px solid " type="email" placeholder="Email Address" aria-label="Email Address">
      ...
      <div class="container-fluid bg-light">
        <div class="row">
          <div class="col-md-6 copyright">
            <p>© 2026 Distro. All rights reserved.</p>
          </div>
