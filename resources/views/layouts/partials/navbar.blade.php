                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                        ...
                        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative"
                            ...
                            <div class="simplebar-wrapper" style="margin: -8px 0px;">
                                ...
                                <div class="simplebar-mask">
                                    <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                            ...
                                            <div class="simplebar-content" style="padding: 8px 0px;">
                                                    ...
                                                    <div class="list-group-item list-group-item-action">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-1">
                                                                ...
                                                                <p class="text-body fs-6">We have successfully received
                                                                    your request.</p>
                                                                <div class="badge rounded-pill bg-light-danger">Unread
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="list-group-item list-group-item-action">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-1">
                                                                ...
                                                                <p class="text-body fs-6">It is a long established fact
                                                                    that a reader will be distracted</p>
                                                                <div class="badge rounded-pill bg-light-success">
                                                                    Confirmation of Account</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
