                                        ...
                                        <tr>
                                            <td class="ps-4">
                                                <div class="d-flex align-items-center">
                                                    @if ($category->image)
                                                        <img src="{{ Storage::url($category->image) }}" class="rounded me-2"
                                                            width="40" height="40">
                                                    @else
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge bg-info-subtle text-dark rounded-3">{{ $category->products_count }}</span>
                                            </td>
                                            <td class="text-center">
                                                @if ($category->is_active)
                                                    <span
                                                        class="badge bg-success-subtle text-success rounded-3">Aktif</span>
                                                @else
                                                    <span
                                                        class="badge bg-secondary-subtle text-secondary rounded-3">Non-Aktif</span>
                                                @endif
                                            </td>
                                            <td class="text-end pe-4">
                                                <button class="btn btn-sm btn-outline-warning me-1 rounded-2"
